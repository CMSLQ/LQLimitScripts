...
sys.path.append ( "card_info_2014_eejj_ttbarFromData" )
sys.path.append ( "card_info_2014_enujj_MT" )
...
systematics = [ "jes", "ees", "shape", "norm", "lumi", "eer", "jer", "pu", "ereco" ]
background_names =  [ "gjet", "qcd", "ttbar", "wjet", "zjet", "vv","stop"  ]

d_backgroundName_mass_useLN = {}
...
for i_signal_name, signal_name in enumerate(signal_names):
    ...
    for i_mass_point, mass_point in enumerate(mass_points):
        ...
        for i_background_name ,background_name in enumerate(background_names):
            ...
            min_entries = min ( float (enujj_entries [background_name][i_mass_point]),
                                float (eejj_entries [background_name][i_mass_point]) )
            ...
            already_know_ln = False

            if background_name not in d_backgroundName_mass_useLN.keys():
                d_backgroundName_mass_useLN[background_name] = {}
            
            if mass_point not in d_backgroundName_mass_useLN[background_name].keys():
                d_backgroundName_mass_useLN[background_name][mass_point] = False
            else:
                already_know_ln = True
